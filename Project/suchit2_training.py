...
from models.suchit2_model import FastSlowModel as Net
from dataloaders.suchit2_dl import CustomImageDataset as Dataset
...
opt = optim.SGD(model.parameters(), lr = .001, momentum=.9)
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), f"chkpts/suchit2_e{epoch}.pt")
    model.eval()
